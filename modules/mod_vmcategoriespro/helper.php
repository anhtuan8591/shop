 ...
 class vmCategoryHelper{
	...
	*/
     ...
     function renderThumb( $path, $width = 100, $height = 100, $title = '', $isThumb = true ){
      ...
      if( $isThumb ){
        ...
        if( file_exists($imagSource)  ) {
          ...
          $thumbPath = JPATH_SITE.DS.'images'.DS.'mod_vmcategoriespro'.DS. str_replace( '/', DS,  $path );
          ...
          $path = JURI::base().'images/mod_vmcategoriespro/'.$path;
        } 
      }
    ...
    function makeDir( $path ){
      ...
      $tmppath =  JPATH_SITE.DS.'images'.DS.'mod_vmcategoriespro'.DS;
