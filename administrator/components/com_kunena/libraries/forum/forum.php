...
abstract class KunenaForum {
	...
	protected static function buildVersion() {
		if ('2.0.2' == '@' . 'kunenaversion' . '@') {
			...
			self::$version = strtoupper ( '2.0.2' );
		}
		self::$version_major = substr(self::$version, 0, 3);
		self::$version_date = ('2012-09-02' == '@' . 'kunenaversiondate' . '@') ? JFactory::getDate()->toMySQL() : '2012-09-02';
		self::$version_name = ('Botschafter' == '@' . 'kunenaversionname' . '@') ? 'Git Repository' : 'Botschafter';
	}
}
