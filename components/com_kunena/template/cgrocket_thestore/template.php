...
/**
* Kunena Component
* @package Kunena.Template.cgrocket_thestore
*
...
class KunenaTemplatecgrocket_thestore extends KunenaTemplate {
	// Try to find missing files from the following parent templates:
	protected $default = array('cgrocket_thestore');
	...
	public function initialize() {
		KunenaFactory::loadLanguage('com_kunena.tpl_cgrocket_thestore');
